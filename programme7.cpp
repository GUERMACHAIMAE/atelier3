...
class vecteur3d {
	...
	vecteur3d somme(const vecteur3d & v) {
		vecteur3d s;
		s.x = x + v.x;      s.y = y + v.y;     s.z = z + v.z;
		return s;    //Ou return vecteur3d(x+v.x, y+v.y, z+v.z);
	}
...
int main() {
	vecteur3d v1(3,6,5);   //  vecteur v1
	cout << "Vecteur V1";
	v1.afficher();
	vecteur3d v2(8,9,7);   //  vecteur v2
	cout << "Vecteur V2";
	v2.afficher();
	cout<<endl;
